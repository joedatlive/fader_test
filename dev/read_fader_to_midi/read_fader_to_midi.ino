...
int bitShift(int InputBits, int Shift){
  // Bit shift to the right by Shift value to convert for example a 10 bit signal to a 7 bit signal
  // The ADC gives a 10 bit value and midi takes a 7 bit value
  int ShiftedBits = InputBits >> Shift;
  return ShiftedBits;
}
